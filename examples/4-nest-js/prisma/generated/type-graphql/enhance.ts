...
const outputsInfo = {
  ...
  PostGroupBy: ["id", "createdAt", "updatedAt", "published", "title", "content", "authorId", "foo", "_count", "_avg", "_sum", "_min", "_max"],
  AffectedRowsOutput: ["count"],
  UserCount: ["posts"],
  UserCountAggregate: ["id", "email", "name", "_all"],
  UserMinAggregate: ["id", "email", "name"],
  UserMaxAggregate: ["id", "email", "name"],
  PostCountAggregate: ["id", "createdAt", "updatedAt", "published", "title", "content", "authorId", "foo", "_all"],
  PostAvgAggregate: ["foo"],
  PostSumAggregate: ["foo"],
  PostMinAggregate: ["id", "createdAt", "updatedAt", "published", "title", "content", "authorId", "foo"],
  PostMaxAggregate: ["id", "createdAt", "updatedAt", "published", "title", "content", "authorId", "foo"]
};
...
const inputsInfo = {
  ...
  PostWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "published", "title", "content", "author", "authorId", "foo"],
  PostOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "published", "title", "content", "author", "authorId", "foo"],
  PostWhereUniqueInput: ["id"],
  PostOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "published", "title", "content", "authorId", "foo", "_count", "_avg", "_max", "_min", "_sum"],
  PostScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "published", "title", "content", "authorId", "foo"],
  UserCreateInput: ["id", "email", "name", "posts"],
  UserUpdateInput: ["id", "email", "name", "posts"],
  UserUpdateManyMutationInput: ["id", "email", "name"],
  PostCreateInput: ["id", "createdAt", "updatedAt", "published", "title", "content", "foo", "author"],
  PostUpdateInput: ["id", "createdAt", "updatedAt", "published", "title", "content", "foo", "author"],
  PostUpdateManyMutationInput: ["id", "createdAt", "updatedAt", "published", "title", "content", "foo"],
  ...
  PostCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "published", "title", "content", "authorId", "foo"],
  PostAvgOrderByAggregateInput: ["foo"],
  PostMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "published", "title", "content", "authorId", "foo"],
  PostMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "published", "title", "content", "authorId", "foo"],
  PostSumOrderByAggregateInput: ["foo"],
  ...
  PostCreateWithoutAuthorInput: ["id", "createdAt", "updatedAt", "published", "title", "content", "foo"],
  PostCreateOrConnectWithoutAuthorInput: ["where", "create"],
  PostUpsertWithWhereUniqueWithoutAuthorInput: ["where", "update", "create"],
  PostUpdateWithWhereUniqueWithoutAuthorInput: ["where", "data"],
  PostUpdateManyWithWhereWithoutAuthorInput: ["where", "data"],
  PostScalarWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "published", "title", "content", "authorId", "foo"],
  ...
  PostUpdateWithoutAuthorInput: ["id", "createdAt", "updatedAt", "published", "title", "content", "foo"]
};
